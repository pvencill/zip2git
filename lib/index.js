...
function updateRepo(dir, remote, options, cb){
    ...
    debugger;
        ...
        var gitAdd = spawn('git',['--git-dir='+subDir+'/.git','--work-tree='+subDir,'add', '.']);
        gitAdd.on('error', cb);
        ...
        gitAdd.on('close', function(code){
            ...
            var gitCommit = spawn('git',['--git-dir='+subDir+'/.git','--work-tree='+subDir,'commit','-am '+commitMsg]);
            ...
            gitCommit.on('close', function(code){
                ...
                debugger;
                var gitPush= spawn('git',['--git-dir='+subDir+'/.git','--work-tree='+subDir,'push']);
                gitPush.on('error', cb);
